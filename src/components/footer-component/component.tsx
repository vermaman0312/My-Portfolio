        ...
        <div className="w-full flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="w-full flex flex-col items-start gap-2">
              <div className="flex items-center justify-center gap-4">
                <button className="border-2 border-[#DAC5A7] border-opacity-15 bg-[#DAC5A7] bg-opacity-5 p-2 rounded-full">
                  <Github className="text-[#DAC5A7] w-5 h-5" />
                </button>
                <p className="text-[#DAC5A7] text-opacity-60 font-display uppercase text-xl font-extralight">
                  Github
                </p>
              </div>
              <div className="flex items-center justify-center gap-4">
                <button className="border-2 border-[#DAC5A7] border-opacity-15 bg-[#DAC5A7] bg-opacity-5 p-2 rounded-full">
                  <Linkedin className="text-[#DAC5A7] w-5 h-5" />
                </button>
                <p className="text-[#DAC5A7] text-opacity-60 font-display uppercase text-xl font-extralight">
                  Linkedin
                </p>
              ...
              <div className="flex items-center justify-center gap-4">
                <button className="border-2 border-[#DAC5A7] border-opacity-15 bg-[#DAC5A7] bg-opacity-5 p-2 rounded-full">
                  <Instagram className="text-[#DAC5A7] w-5 h-5" />
                </button>
                <p className="text-[#DAC5A7] text-opacity-60 font-display uppercase text-xl font-extralight">
                  Instagram
                </p>
              ...
              <div className="flex items-center justify-center gap-4">
                <button className="border-2 border-[#DAC5A7] border-opacity-15 bg-[#DAC5A7] bg-opacity-5 p-2 rounded-full">
                  <Twitter className="text-[#DAC5A7] w-5 h-5" />
                </button>
                <p className="text-[#DAC5A7] text-opacity-60 font-display uppercase text-xl font-extralight">
                  Twitter
                </p>
          ...
          <div className="flex flex-col items-center justify-start gap-4">
            ...
            <div className="w-full flex flex-col items-start gap-2">
              <div className="flex items-center justify-center gap-4">
                <button className="border-2 border-[#DAC5A7] border-opacity-15 bg-[#DAC5A7] bg-opacity-5 p-2 rounded-full">
                  <House className="text-[#DAC5A7] w-5 h-5" />
                </button>
                <p className="text-[#DAC5A7] text-opacity-60 font-display uppercase text-xl font-extralight">
                  Home
                </p>
              ...
              <div className="flex items-center justify-center gap-4">
                <button className="border-2 border-[#DAC5A7] border-opacity-15 bg-[#DAC5A7] bg-opacity-5 p-2 rounded-full">
                  <HandPlatter className="text-[#DAC5A7] w-5 h-5" />
                </button>
                <p className="text-[#DAC5A7] text-opacity-60 font-display uppercase text-xl font-extralight">
                  Services
                </p>
              ...
              <div className="flex items-center justify-center gap-4">
                <button className="border-2 border-[#DAC5A7] border-opacity-15 bg-[#DAC5A7] bg-opacity-5 p-2 rounded-full">
                  <PersonStanding className="text-[#DAC5A7] w-5 h-5" />
                </button>
                <p className="text-[#DAC5A7] text-opacity-60 font-display uppercase text-xl font-extralight">
                  About
                </p>
              ...
              <div className="flex items-center justify-center gap-4">
                <button className="border-2 border-[#DAC5A7] border-opacity-15 bg-[#DAC5A7] bg-opacity-5 p-2 rounded-full">
                  <ReceiptText className="text-[#DAC5A7] w-5 h-5" />
                </button>
                <p className="text-[#DAC5A7] text-opacity-60 font-display uppercase text-xl font-extralight">
                  Contact
                </p>
