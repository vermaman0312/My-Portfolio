...
import PortfolioAboutEducationPageComponent from "./components/education-component";
  ...
  return (
    <div className="w-full flex items-center justify-center flex-col">
      ...
      <div className="mt-5 flex flex-col items-center justify-center">
        <div>
          <CustomLabel className="text-[#DAC5A7] font-display text-xs font-light text-opacity-60 text-center md:w-[50rem]">
            I have a strong educational background that has equipped me with the
            skills and knowledge to excel in technology. My learning journey
            fuels my passion for innovation and continuous improvement.
          </CustomLabel>
        </div>
        <div>
          <PortfolioAboutEducationPageComponent />
        </div>
      </div>
    </div>
  );
