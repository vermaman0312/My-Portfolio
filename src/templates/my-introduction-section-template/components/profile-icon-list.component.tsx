...
export const MernComponent = () => {
  return (
    <div className="w-8 h-8 text-white">
      <img src={mern_logo} alt="" />
    </div>
  );
};
...
export const DockerComponent = () => {
  return (
    <div className="w-8 h-8 text-white">
      <img src={docker_logo} alt="" />
    </div>
  );
};
...
export const ShellScriptComponent = () => {
  return (
    <div className="w-8 h-8 text-white">
      <img src={shellscript_logo} alt="" />
    </div>
  );
};
export const KaliLinuxComponent = () => {
  return (
    <div className="w-8 h-8 text-white">
      <img src={kalilinux_logo} alt="" />
    </div>
  );
};
